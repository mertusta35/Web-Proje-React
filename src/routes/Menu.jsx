      ...
      <Container>
        <Row className='py-5'>
          ...
          <Col className='col-xl-3 d-flex ' >
            <Button variant="outline-danger d-block mx-auto px-3">Giriş Yap</Button>
        ...
        <Container >
          ...
          <Navbar.Collapse id="navbarScroll">
            <Nav className="mx-auto  my-lg-0 text-uppercase ">
              ...
              <Nav.Link href="" className='text-white'>ÇİZGİ ROMAN</Nav.Link>
              <Nav.Link href="" className='text-white'>HOBİ & KIRTASİYE</Nav.Link>
            </Nav>
